...
Route::group(['prefix' => 'api'], function () {
    ...
    Route::post('comment/add-projectcomment','API\ProjectCommentApiController@addProjectComment');
    Route::post('comment/add-commentcomment','API\ProjectCommentApiController@addCommentComment');
