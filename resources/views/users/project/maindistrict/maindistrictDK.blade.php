...
@section('content')
    <div style="display:none;" id="myDiv" class="animate-bottom">
        <div class="ui small breadcrumb">
            ...
            <i class="right chevron icon divider"></i>
            <div class="active section">อำเภอดอกคำใต้</div>
        </div>
            ...
            <div class="ui grid">
                <div class=" row container">
                    ...
                    <div class="thirteen wide column">
                        ...
                        <h3 class="condensed container"><a name="4">อำเภอดอกคำใต้</a></h3>
                        @include('users.district.dokkhamtai',['name_th' => 'อำเภอดอกคำใต้'])
